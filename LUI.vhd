...
entity LUI is
    ...
    (
        ...
        output : out std_logic_vector(31 downto 0)   -- Saída de 32 bits, com 16 bits inferiores zerados.
    );
...
begin
    ...
    output <= input & "0000000000000000";  -- Adiciona 16 zeros diretamente à entrada para formar a saída.
